...
However, it is almost *always* easier to deal with this kind of quantity after taking the [log](log-exp.md):
...
It is hard to overstate how often you will do this. This isn't some occasional trick -- this is standard operating procedure, so it is critical that you know the properties of [exponents and logs](log-exp.md) extremely well.
